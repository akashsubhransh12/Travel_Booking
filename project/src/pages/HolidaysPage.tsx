  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      ...
      >
        ...
        />
        <h2 className="text-2xl font-bold mb-2">Holiday Packages Coming Soon</h2>
        <p className="text-gray-600 mb-6">
          We're currently working on bringing you amazing holiday packages and vacation deals.
